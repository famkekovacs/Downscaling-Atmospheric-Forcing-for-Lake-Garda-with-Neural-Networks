...
data_path = '/hpc/shared/uu_imau_ocean/kovacs/More_Time/TFRecords/Future/T_mr_hr_test_future.tfrecord'
a_d = 'alpha0.001_dropout0.8'
model_dir = '/'.join([model_name + run_id + a_d, 'gan-all00007/gan'])
data_out_path = '/hpc/shared/uu_imau_ocean/kovacs/More_Time/data_out/temperature/MR_HR/Future/'
