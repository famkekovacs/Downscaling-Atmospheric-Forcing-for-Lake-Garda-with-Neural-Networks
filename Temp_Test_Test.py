"""
Temperature Test Test data larger training size
...
data_path = '/hpc/shared/uu_imau_ocean/kovacs/More_Time/TFRecords/T_mr_hr_test.tfrecord'
a_d = 'alpha0.001_dropout0.8'
model_dir = '/'.join([model_name + run_id + a_d, 'gan-all00007/gan'])
data_out_path = '/hpc/shared/uu_imau_ocean/kovacs/More_Time/data_out/temperature/MR_HR/test/'
